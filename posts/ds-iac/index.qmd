...
The main objective of this project ([available here in Github](https://github.com/paeselhz/iac_ds_stack)) is to create a set of tools that allow the deployment of a data science stack using Packer and Terraform. It comprises the following infrastructure:
