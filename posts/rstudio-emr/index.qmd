...
subtitle: "Easy deployment, reproducible, and fast"
...
A few changes to enhance security were added since December 2020, that require the user to manually allow ports to be publically available as can be found [here](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-man-sec-groups.html). If this is not your case, you can skip to the next session, but, if you desire to expose your RStudio Server instance to be publically accessible through the internet, you have to follow the steps described below:
...
## Configuring the RStudio Server to use the full extent of AWS EMR resources
...
This step can be found [here](https://github.com/paeselhz/emr-spark-client/blob/master/scripts/post-installation-cfg.sh) in the project.
